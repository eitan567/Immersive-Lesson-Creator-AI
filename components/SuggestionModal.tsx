            ...
            <div className="div-cta rounded-2xl w-full max-w-lg relative" onClick={e => e.stopPropagation()}>
                <div className="bg-white dark:bg-zinc-950 rounded-2xl shadow-xl w-full p-6">
                    ...
                    <div className="flex items-center mb-4">
                        <SparklesIcon className="w-6 h-6 text-blue-500 dark:text-blue-400 ml-3" />
                        ...
                        <div className="space-y-3 max-h-80 overflow-y-auto pr-2">
                            {suggestions.map((suggestion, index) => (
                                <button
                                    ...
                                    className="w-full text-right p-4 bg-gray-50 dark:bg-zinc-800 rounded-lg border border-gray-200 dark:border-zinc-700 hover:bg-blue-100 dark:hover:bg-zinc-700 hover:border-blue-400 dark:hover:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-400 transition-all text-gray-700 dark:text-gray-200"
                                >
                                    {suggestion}
                                </button>
                            ))}
