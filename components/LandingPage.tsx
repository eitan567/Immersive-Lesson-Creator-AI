...
const FeatureCard: React.FC<{ icon: React.ReactNode; title: string; description: string }> = ({ icon, title, description }) => (
    <div className="div-cta rounded-xl transform hover:-translate-y-2 transition-transform duration-300 h-full">
        <div className="p-6 bg-white dark:bg-zinc-950 rounded-xl shadow-lg text-center h-full">
            <div className="flex justify-center items-center mb-4">
                <div className="bg-blue-100 dark:bg-blue-900/50 text-blue-600 dark:text-blue-400 p-4 rounded-full">{icon}</div>
            </div>
...
const LandingPage: React.FC<LandingPageProps> = ({ onEnter, onNavigateHome }) => {
    ...
    const navLinks = (
        <>
            <button onClick={() => handleScrollTo('features')} className="text-lg font-semibold text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors py-2 md:py-0">פיצ'רים</button>
            <button onClick={() => handleScrollTo('how-it-works')} className="text-lg font-semibold text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors py-2 md:py-0">איך זה עובד?</button>
            <button onClick={() => handleScrollTo('testimonials')} className="text-lg font-semibold text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors py-2 md:py-0">המלצות</button>
        </>
    );
        ...
        <div className="bg-gray-50 dark:bg-zinc-900 text-gray-800 dark:text-gray-200" dir="rtl">
            ...
            <section className="py-20 md:py-32 text-center bg-white dark:bg-zinc-900">
                <div className="container mx-auto px-6">
                    ...
                    <button
                        onClick={onEnter}
                        className="btn-cta mt-10 px-10 py-4 text-black dark:text-white text-xl font-bold rounded-full focus:outline-none focus:ring-4 focus:ring-blue-300 transition-all duration-300 transform hover:scale-105"
                    >
                        התחילו ליצור בחינם
                    </button>
                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 text-center md:text-right">
                        ...
                        <div className="space-y-4">
                            ...
                            <ul className="space-y-3">
                                <li><button onClick={() => handleScrollTo('features')} className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">פיצ'רים</button></li>
                                <li><button onClick={() => handleScrollTo('how-it-works')} className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">איך זה עובד?</button></li>
                                <li><button onClick={() => handleScrollTo('testimonials')} className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">המלצות</button></li>
                                <li><button onClick={onEnter} className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">כניסה למערכת</button></li>
                            </ul>
                        </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <ul className="space-y-3">
                                <li><a href="#" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">מדיניות פרטיות</a></li>
                                <li><a href="#" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">תנאי שימוש</a></li>
                                <li><a href="#" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">צור קשר</a></li>
                            </ul>
                        </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex space-x-4 space-x-reverse justify-center md:justify-start">
                                <a href="#" className="text-gray-500 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400 p-2 rounded-full hover:bg-gray-100 dark:hover:bg-zinc-800 transition-colors" title="Facebook">
                                    <span className="sr-only">Facebook</span>
                                    <svg fill="currentColor" className="w-6 h-6" viewBox="0 0 24 24">
                                      <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v2.385z"/>
                                    </svg>
                                </a>
                                <a href="#" className="text-gray-500 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400 p-2 rounded-full hover:bg-gray-100 dark:hover:bg-zinc-800 transition-colors" title="Twitter/X">
                                ...
                                <a href="#" className="text-gray-500 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400 p-2 rounded-full hover:bg-gray-100 dark:hover:bg-zinc-800 transition-colors" title="LinkedIn">
